...
fun SettingsScreen(
    ...
    val listOfIcons = listOf(R.drawable.light_theme, R.drawable.notification, R.drawable.delete_account, R.drawable.language_icon, R.drawable.prescription)
        ...
        Column(
            ...
            Surface(
                ...
                Column {
                    ...
                    ListItem(
                        headlineContent = { Text(listOfItems[4]) },
                        leadingContent = {
                            Icon(
                                painter = painterResource(listOfIcons[4]),
                                contentDescription = null,
                                modifier = Modifier.size(24.dp),
                                tint = MaterialTheme.colorScheme.primary
                            )
                        ...
                        modifier = Modifier.clickable {
                            navController.navigate(Route.MEDICATION_SETTINGS.route)
                        }
                    )
